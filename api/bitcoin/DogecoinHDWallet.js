...
/**!!!
 * A Dogecoin Hierarchical Deterministic (HD) Wallet JS Implementation
 *
...
export default class DogecoinHDWallet {
  ...
  constructor() {
    ...
    /**
     * Dogecoin Legacy Address - Derived from the Grand Child Public Key Hash
     */

    this.dogecoinLegacyAddress = ''

    /**
     * TESTNET Dogecoin Legacy Address (Derived from the Grand Child Public Key Hash) - THIS IS TESTNET
     */

    this._tdogecoinLegacyAddress = ''
  ...
  generateDerivedChildKeys() {
    ...
    const derivePublicGrandChildKey = () => {
      ...
      /**
       * Derive Dogecoin Legacy Address
       */
      ...
      // Append CheckSum
      const _dogecoinLegacyAddress = k.concat(...addressCheckSum)

      // Convert to Base58
      this.dogecoinLegacyAddress = Base58.encode(_dogecoinLegacyAddress)


      /**
       * Derive TESTNET Dogecoin Legacy Address
       */
      ...
      // Append CheckSum
      const _tdogecoinLegacyAddress = tK.concat(...tAddressCheckSum)

      // Convert to Base58
      this._tdogecoinLegacyAddress = Base58.encode(_tdogecoinLegacyAddress)
    }
  ...
  returnWallet() {
    ...
    const wallet = {
      ...
      address: this.dogecoinLegacyAddress,
      _taddress: this._tdogecoinLegacyAddress
    }
